...
- **Modelo de múltiplos funis** — a base de dados passa a suportar um lead participando de vários funis simultaneamente, cada um com sua própria etapa, valor estimado e desfecho. Os 2.801 leads existentes foram migrados para um funil `Geral` de triagem, e todo lead novo entra nele automaticamente.
