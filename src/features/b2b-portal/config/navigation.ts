...
export const PORTAL_NAV: IPortalNavItem[] = [
  ...
  { label: "Faturamento", icon: "mdi:file-document-outline", to: "/portal/faturamento", requires: "canViewFinancial" },
  { label: "Análise", icon: "mdi:chart-box-outline", to: "/portal/analise" },
  { label: "Usuários", icon: "mdi:account-group-outline", to: "/portal/usuarios", roles: ["admin"] },
