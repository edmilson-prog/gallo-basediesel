...
export const LEADS_STRINGS = {
  ...
  /** Painel lateral do Atendimento — ui_kits/atendimento/painel/painel-lead-v2-conversao.html */
  panel: {
    leadChip: "Lead",
    ...
    lockedHint: (label: string) => `${label} — disponível após converter em cliente`,
    conversion: {
      title: "Conversão em cliente",
      readyTitle: "Dados obrigatórios completos",
      readyBody: "Converter libera pedidos, entregas e métricas.",
      missingTitle: (count: number) =>
        count === 1 ? "1 dado obrigatório faltando" : `${count} dados obrigatórios faltando`,
      missingBody: "Preencha para habilitar a conversão.",
      convert: "Converter em cliente",
      blockedHint: "Faltam dados obrigatórios para converter.",
      linkExisting: "Vincular a cliente existente",
      onlyQuote: "Só orçamento",
      onlyQuoteHint: "Fazer um orçamento sem converter o lead.",
      personal: "É pessoal",
      personalHint: "Contato pessoal — esconde a conversão nesta ficha.",
      personalUndo: "Voltar a tratar como cliente em potencial",
      personalApplied: "Marcado como contato pessoal.",
      personalRemoved: "Voltou a aparecer como conversão pendente.",
      personalBanner: "Contato pessoal — a conversão está oculta.",
      fill: "informar",
      fields: {
        phone: "Telefone",
        name: "Nome completo",
      ...
      hints: {
        whatsappName: "hoje: nome do WhatsApp",
      },
      editTitle: (label: string) => `Informar ${label.toLowerCase()}`,
      save: "Salvar",
      cancel: "Cancelar",
      invalidDocument: "CPF ou CNPJ inválido.",
      invalidEmail: "E-mail inválido.",
      requiredName: "Informe o nome.",
      requiredCity: "Informe a cidade.",
      addressCity: "Cidade",
      addressState: "UF",
    ...
    funnel: {
      title: "Funil",
      addToFunnel: "Adicionar a outro funil",
      estimatedValue: "Valor estimado",
    },
    registry: {
      title: "Conversa e registro",
      status: "Status",
      assignee: "Atendente",
      instance: "Respondendo por",
    ...
    conversations: {
      ...
      empty: "Nenhuma outra conversa com este contato.",
      open: "Abrir",
    },
    notes: {
      empty: "Nenhuma anotação neste lead.",
      placeholder: "Escrever uma anotação…",
      add: "Anotar",
      saved: "Anotação registrada.",
      error: "Não foi possível salvar a anotação.",
    },
    history: {
      empty: "Nada registrado ainda.",
      conversation: (count: number) =>
        count === 1 ? "Conversa com 1 mensagem" : `Conversa com ${count} mensagens`,
      note: "Anotação",
    },
    locked: {
      body: (label: string) =>
        `${label} passa a existir quando este lead virar cliente. Converta na Visão geral para liberar.`,
      cta: "Ir para a conversão",
    },
  },
} as const;
