...
export function QuotesColumnsDropdown({ visible, onToggle, onShowAll }: IColumnsMenuProps) {
  return (
    <DropdownMenu>
...
/** Context-menu content only — the trigger wraps the header row in QuotesTable. */
export function QuotesColumnsContextContent({ visible, onToggle, onShowAll }: IColumnsMenuProps) {
  return (
