...
import { PAGE_SIZES, type QuotesPageSize } from "../../utils/listFilters";
...
export function QuotesPagination({
  ...
  onPageSizeChange: (size: QuotesPageSize) => void;
}) {
    ...
    <div className="flex items-center justify-between gap-3 border-t border-border bg-background px-4 py-2 text-xs md:px-6">
      <div className="flex items-center gap-2 text-muted-foreground">
        ...
        <Select
          ...
          onValueChange={(v) => onPageSizeChange(Number(v) as QuotesPageSize)}
        >
