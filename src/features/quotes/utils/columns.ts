/**
 * Configurable columns for the quotes list table (cockpit/console layouts).
 *
 * Mandatory column (always visible): number — the row identifier.
 * Toggleable columns are persisted in `localStorage` under `gallo-quotes-columns`.
 */
...
export const COLUMNS_LOCALSTORAGE_KEY = "gallo-quotes-columns";
