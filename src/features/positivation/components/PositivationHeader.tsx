...
export interface IPositivationHeaderProps {
  filters: IPositivationFiltersState;
  storeLocked: boolean;
  sellerLocked: boolean;
  activeFilterCount: number;
  onPeriod: (period: PositivationPeriodPreset) => void;
  onStore: (store: ID | "all") => void;
  onSeller: (seller: ID | "all") => void;
  onReset: () => void;
}

const PERIOD_OPTIONS: { value: PositivationPeriodPreset; label: string }[] = [
  { value: "month_current", label: S.periodMonthCurrent },
  { value: "month_previous", label: S.periodMonthPrevious },
  { value: "quarter_current", label: S.periodQuarterCurrent },
  { value: "ytd", label: S.periodYtd },
];

export function PositivationHeader({
  filters,
  storeLocked,
  sellerLocked,
  activeFilterCount,
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="start">
            ...
            <DropdownMenuRadioGroup
              ...
              onValueChange={(v) => onPeriod(v as PositivationPeriodPreset)}
            >
