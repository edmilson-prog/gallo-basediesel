      ...
      .then((loaded) => {
        ...
        setSettings(
          loaded ?? {
            ...
            // Reading parameters. They belong to the panel's "Parâmetros" tab,
            // not to this screen, but they are carried so a save from here is a
            // complete INpsSettings and never blanks what that tab owns.
