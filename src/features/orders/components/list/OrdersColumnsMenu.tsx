...
export function OrdersColumnsDropdown({ visible, onToggle, onShowAll }: IColumnsMenuProps) {
  return (
    <DropdownMenu>
...
/** Context-menu content only — the trigger wraps the header row in OrdersTable. */
export function OrdersColumnsContextContent({ visible, onToggle, onShowAll }: IColumnsMenuProps) {
  return (
