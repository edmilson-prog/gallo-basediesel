...
| 002 | [Modelo Conceitual de Domínio e Glossário](./PRD-002-modelo-conceitual-glossario.md) | Feature | D | 🔵 | 📝 | ⏳ | — |
...
|--------|----------|---------------|----------------|-------|
| v0.1.0 | **Genesis** | Mês 1 | PRDs 001, 002, 003 | Fundação completa (scaffold Lovable) |
...
|---------|----------------|--------------------|-----------------|
| Maio/2026 | 4 | 0 | — (pré-implementação) |
...
### Lote 1 — Fundação (em andamento — 4/7 redigidos)
...
|-------|-------|
| **Data** | 25/05/2026 |
| **Atualizado por** | Edmilson Souza (Arquiteto) + Claude Opus 4.7 (sessão de planejamento) |
| **Motivo** | Criação inicial do índice consolidado após redação dos 4 primeiros PRDs do Bloco 0 (Fundação) |
