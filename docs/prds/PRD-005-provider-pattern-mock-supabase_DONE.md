...
| **Versão do App**         | 0.4.0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| **Codinome**              | Hub                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| **Implementado por**      | Claude Code CLI (Opus 4.7)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| **Observações**           | 16 contratos, 16 mocks delegantes, 16 esqueletos Supabase, 16 hooks, factory parametrizada por `VITE_DATA_SOURCE` e Context montado no `__root.tsx`. ESLint bloqueia importações cruzadas com exceção dev-only para `src/routes/design-system.tsx`. Contratos espelham 1:1 as APIs reais do PRD-004 (assinatura exata do mock atual), por isso métodos idealizados no exemplo do PRD que não existem no PRD-004 (`convertToOrder`, `convertToCustomer`, etc.) ficaram fora do escopo — entrarão quando o mock subjacente os adicionar. Tipo `IPaginatedResult/IPaginationParams` foi redeclarado em `contracts/_shared.ts` para preservar o isolamento (contratos não dependem de `@/mocks`). |
