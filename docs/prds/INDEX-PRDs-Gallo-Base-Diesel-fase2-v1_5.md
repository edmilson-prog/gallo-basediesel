# Índice de PRDs — GALLO BASE DIESEL — Fase 2 — v1.5
...
> Paralelismo possível: Onda 5 pode iniciar antes de 109/110 concluírem (deixar PRDs 118 e 120 por último, pois integram com o 110).

### Redação (Arquiteto) — Lote 4 — Onda 7 (Pagamentos)
...
| **Motivo** | Atualização v1.5 — **sincronização com o estado real do repositório**: PRDs 100–108 implementados pelo Claude Code CLI (`_DONE`), sem desvios; app em v2.0.0-rc.8. Faltam 109 e 110 para fechar Onda 4. Revisão arquitetural completa dos 32 PRDs concluída em 09/06 — integridade confirmada, nenhuma correção de conteúdo necessária. Seção "Próximos Passos" reestruturada com ordem de implementação para o CLI + redação do Lote 4. |
