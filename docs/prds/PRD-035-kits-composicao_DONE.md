...
| **Versão do App**         | v0.64.0 — Kit                                                                                                                                         |
| **Implementado por**      | Claude Opus 4.8 (1M) via subagent-driven-development                                                                                                  |
| **Observações**           | Consolidação do `IServiceKit` → `IVehicleModelKit` (recomeço limpo). Matching por string até PRD-016. RF-015 (SDR) N/A: SDR é bot, sem montagem manual. |
