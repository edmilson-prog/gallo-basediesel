...
A Fase 2 está organizada em **10 ondas** de aproximadamente 10 PRDs cada, totalizando 100 PRDs na faixa 100–200:

| Onda | Faixa   | Tema                            | Duração estimada | Prioridade      |
| ---- | ------- | ------------------------------- | ---------------- | --------------- |
| 4    | 100–110 | **Backend Supabase Real**       | 8–12 semanas     | P0 — bloqueante |
| 5    | 111–120 | **WhatsApp Real**               | 6–8 semanas      | P0              |
| 6    | 121–130 | **Integração DINTEC ERP**       | 10–14 semanas    | P0              |
| 7    | 131–140 | **Pagamentos**                  | 8–10 semanas     | P0              |
| 8    | 141–150 | **Notificações Reais**          | 4–6 semanas      | P0/P1           |
| 9    | 151–160 | **LLM / IA Real**               | 8–12 semanas     | P0/P1           |
| 10   | 161–170 | **B2B Corporativo Funcional**   | 10–12 semanas    | P0/P1           |
| 11   | 171–180 | **PWA Offline-First**           | 6–8 semanas      | P1/P2           |
| 12   | 181–190 | **Multi-loja + Equipes Ativas** | 6–8 semanas      | P1/P2           |
| 13   | 191–200 | **Compliance + ML Avançado**    | 10–14 semanas    | P0/P3           |

**Total estimado:** 76–114 semanas (~18–26 meses) de desenvolvimento contínuo, com possibilidade de paralelização em squads.
...
| Pagamento        | configuração por método               | mock / asaas / iugu / stripe / pagar-me |
| Frete            | configuração por estratégia           | mock / correios / transportadora-X      |
| LLM              | configuração global                   | mock / anthropic / openai (fallback)    |
| Email            | configuração global                   | mock / resend / sendgrid / ses          |
...
| **NF placeholder**                                                                                          | PRD-032       | **PRD-127 Fase 2** (NF via DINTEC)                                       |
...
| #   | Título                              | Tipo       | Prof. | Prior. | Complexidade | Depende de       |
| --- | ----------------------------------- | ---------- | ----- | ------ | ------------ | ---------------- |
| 121 | Discovery e Contrato Técnico DINTEC | Integração | D     | P0     | Alta         | —                |
| 122 | Provider DINTEC base                | Integração | D     | P0     | Alta         | 121, 102         |
| 123 | Sync de Catálogo                    | Feature    | D     | P0     | Alta         | 122, Fase 1: 030 |
| 124 | Sync de Estoque                     | Feature    | D     | P0     | Alta         | 122, Fase 1: 030 |
| 125 | Sync de Clientes                    | Feature    | D     | P1     | Média        | 122, Fase 1: 012 |
| 126 | Sync de Pedidos                     | Feature    | D     | P0     | Alta         | 122, Fase 1: 032 |
| 127 | NF Eletrônica via DINTEC            | Integração | D     | P0     | Alta         | 122, 126, 106    |
| 128 | Conflict Resolution Cross-System    | Feature    | D     | P1     | Alta         | 123–127          |
| 129 | Importação CSV (fallback)           | Feature    | D     | P2     | Média        | 123              |
...
| #   | Título                      | Tipo       | Prof. | Prior. | Complexidade | Depende de       |
| --- | --------------------------- | ---------- | ----- | ------ | ------------ | ---------------- |
| 131 | PIX Open Banking estrutura  | Integração | D     | P0     | Média        | 104              |
| 132 | PIX QR Code Dinâmico        | Feature    | D     | P0     | Média        | 131, Fase 1: 064 |
| 133 | PIX Webhook (Confirmação)   | Integração | D     | P0     | Alta         | 132              |
| 134 | Boleto Bancário             | Integração | D     | P1     | Média        | 131              |
| 135 | Cartão de Crédito           | Integração | D     | P1     | Alta         | 131              |
| 136 | Parcelamento                | Feature    | D     | P1     | Alta         | 134, 135         |
| 137 | Refund Automático           | Feature    | D     | P1     | Alta         | 132, 134, 135    |
...
| #   | Título                              | Tipo       | Prof. | Prior. | Complexidade | Depende de           |
| --- | ----------------------------------- | ---------- | ----- | ------ | ------------ | -------------------- |
| 151 | LangChain + LLM Gateway             | Integração | D     | P0     | Alta         | 102                  |
| 152 | Insights via LLM                    | Feature    | D     | P1     | Crítica      | 151, Fase 1: 053     |
| 153 | SDR Avançado com LLM                | Feature    | D     | P0     | Crítica      | 151, Fase 1: 020–024 |
| 154 | Análise de Sentimento               | Feature    | D     | P2     | Alta         | 151, Fase 1: 051     |
| 155 | Sugestões de Ação Contextualizadas  | Feature    | D     | P2     | Alta         | 151                  |
...
| Visão                          | Quantidade |
| ------------------------------ | ---------- |
| **Total PRDs Fase 2**          | 100        |
| **Detalhados (D)**             | 74         |
| **Esqueletos (E)**             | 26         |
| **Integrações (I/Integração)** | 19         |
| **P0 (bloqueante go-live)**    | 26         |
| **P1 (alta)**                  | 30         |
| **P2 (média)**                 | 21         |
| **P3 (futuro)**                | 23         |
...
| 3    | 6 — DINTEC           | 121–130 | 10      | 4–5               | (121,122), (123,124,125), (126,127), (128,129,130)     |
| 4    | 7 — Pagamentos       | 131–140 | 10      | 4                 | (131,132,133), (134,135,136), (137,138), (139,140)     |
| 5    | 8 — Notificações     | 141–150 | 10      | 3–4               | (141,142,143), (144,145,146), (147,148), (149,150)     |
| 6    | 9 — LLM/IA           | 151–160 | 10      | 4                 | (151,160), (152,153), (154,155,156), (157,158,159)     |
...
| 6    | DINTEC (licença adicional para API)      | A negociar com fornecedor                      |
| 7    | Gateway de pagamento (Asaas/Iugu/Stripe) | 1.99–3.99% por transação (variável)            |
| 7    | Antifraude básico                        | R$ 0,30 – 1,00 por análise                     |
| 8    | Email transacional (Resend/SendGrid)     | R$ 100 – 400                                   |
| 8    | SMS (Twilio)                             | R$ 0,10 – 0,30 por SMS                         |
| 9    | **LLM (Anthropic Claude API)**           | **R$ 1.500 – 8.000** (alto, depende de volume) |
| 9    | Modelos de fallback (OpenAI)             | R$ 500 – 2.000                                 |
...
**Total mensal estimado pós-Onda 9:** R$ 5.000 – 18.000 (com LLM e WhatsApp em volume)

**Recomendação:** PRD-100 deve incluir orçamento operacional mensal cliente-cliente revisado a cada onda; Owner valida custos antes de cada gate de validação.
...
| ------------------------------------------------------ | ------------- | ------- | ----------------------------------------------------------------------------------------------- |
| DINTEC não tem API moderna ou limitações severas       | Média         | Alto    | PRD-121 (Discovery) é P0 — descobrir cedo, plano B com importação CSV (PRD-129)                 |
...
| Custo LLM escala além do orçamentado                   | Alta          | Alto    | PRD-151 inclui cost tracking + alertas; cache agressivo; modelos menores quando possível        |
...
### 13.2 Decisões em aberto (validar com Edmilson antes da escrita)

Antes de começar a escrita dos PRDs Fase 2, três decisões precisam validação formal:

1. **Provider de pagamento:** Asaas, Iugu, Stripe, Pagar.me ou outro? PRD-131 depende dessa escolha. Recomendação técnica: Asaas pelo foco brasileiro, PIX nativo, custo competitivo.

2. **Provider de email transacional:** Resend, SendGrid, AWS SES? PRD-141. Recomendação: Resend pela simplicidade e custo em volumes médios.

3. **Provider de LLM principal:** Anthropic Claude (preferência institucional do projeto), com OpenAI como fallback? PRD-151. Recomendação: confirmar que Claude API atende SLAs necessários; orçamento mensal aprovado.

Outras decisões podem ser tomadas durante a escrita dos PRDs respectivos, com sinalização explícita ("Decisão pendente — definir antes da implementação").
