...
// Source: src/providers/whatsapp/openwa/OpenWaProvider.ts (sync: bun run scripts/sync-whatsapp-shared.ts)
...
import { OPENWA_CAPABILITIES } from "./constants.ts";
import { openwaRequest } from "./client.ts";
import { parseOpenWaInbound } from "./parser.ts";
