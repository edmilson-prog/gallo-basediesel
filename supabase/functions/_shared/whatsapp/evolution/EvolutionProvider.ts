...
// Source: src/providers/whatsapp/evolution/EvolutionProvider.ts (sync: bun run scripts/sync-whatsapp-shared.ts)
...
import { hmacSha256Hex, timingSafeEqualStrings } from "../crypto.ts";
...
import { EVOLUTION_CAPABILITIES, EVOLUTION_SECRET_SUFFIXES } from "./constants.ts";
import { evolutionRequest } from "./client.ts";
import { parseEvolutionInbound } from "./parser.ts";
