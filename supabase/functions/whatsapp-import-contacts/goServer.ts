...
// NOTE: mirrors supabase/functions/whatsapp-connect/goServer.ts (avatar-sync +
// whatsapp-send carry the same query). Kept per-edge to match the existing
// layout — there is no _shared/goServer yet. A future refactor could hoist them.
