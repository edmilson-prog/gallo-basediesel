...
- **SemVer.** MINOR/MAJOR recebem **codinome em inglês** (atual: `Dispatch` — v0.68.0).
...
- **Tags git** acompanham cada bump: `vX.Y.Z` no commit de release/merge (ex.: `v0.67.0` Vault, `v0.68.0` Dispatch).
