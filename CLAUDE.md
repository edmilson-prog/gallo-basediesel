...
- **SemVer.** MINOR/MAJOR recebem **codinome em inglês** (atual: `Stencil` — v0.79.0).
...
- **Tags git** acompanham cada bump: `vX.Y.Z` no commit de release/merge (ex.: `v0.67.0` Vault, `v0.68.0` Dispatch, `v0.69.0` Beacon, `v0.70.0` Guide, `v0.71.0` Focus, `v0.72.0` Bedrock, `v0.73.0` Keystone, `v0.74.0` Backbone, `v0.75.0` Sentinel, `v0.76.0` Bridge, `v0.77.0` Gateway, `v0.78.0` Courier, `v0.79.0` Stencil).
